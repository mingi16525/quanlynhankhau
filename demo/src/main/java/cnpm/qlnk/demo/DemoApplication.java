...
public class DemoApplication {
    ...
    //             VaiTro toTruongRole = vaiTroRepository.save(new VaiTro(null, "TO_TRUONG"));

    //             System.out.println(">>> Creating Permissions...");
    //             // Admin Permissions - Full access
    //             phanQuyenRepository.save(new PhanQuyen(null, adminRole, "*", "*"));
                
    //             // CanBoNK Permissions - Full CRUD cho Nhân khẩu, Hộ khẩu, Thành viên hộ, Tam trú tạm vắng, Sự kiện, Ghi nhận
    ...
    //                     new PhanQuyen(null, canBoNKRole, "NHAN_KHAU", "DELETE"),
    //                     // Hộ khẩu - Full CRUD
    ...
    //                     // Thành viên hộ - Full CRUD
    //                     new PhanQuyen(null, canBoNKRole, "THANH_VIEN_HO", "READ"),
    //                     new PhanQuyen(null, canBoNKRole, "THANH_VIEN_HO", "CREATE"),
    //                     new PhanQuyen(null, canBoNKRole, "THANH_VIEN_HO", "UPDATE"),
    //                     new PhanQuyen(null, canBoNKRole, "THANH_VIEN_HO", "DELETE"),
    //                     // Tam trú tạm vắng - Full CRUD
    //                     new PhanQuyen(null, canBoNKRole, "TAM_TRU_VANG", "READ"),
    //                     new PhanQuyen(null, canBoNKRole, "TAM_TRU_VANG", "CREATE"),
    //                     new PhanQuyen(null, canBoNKRole, "TAM_TRU_VANG", "UPDATE"),
    //                     new PhanQuyen(null, canBoNKRole, "TAM_TRU_VANG", "DELETE"),
    //                     // Sự kiện - Full CRUD
    //                     new PhanQuyen(null, canBoNKRole, "SU_KIEN", "READ"),
    //                     new PhanQuyen(null, canBoNKRole, "SU_KIEN", "CREATE"),
    //                     new PhanQuyen(null, canBoNKRole, "SU_KIEN", "UPDATE"),
    //                     new PhanQuyen(null, canBoNKRole, "SU_KIEN", "DELETE"),
    //                     // Ghi nhận thay đổi hộ khẩu - Full CRUD
    //                     new PhanQuyen(null, canBoNKRole, "GHI_NHAN", "READ"),
    //                     new PhanQuyen(null, canBoNKRole, "GHI_NHAN", "CREATE"),
    //                     new PhanQuyen(null, canBoNKRole, "GHI_NHAN", "UPDATE"),
    //                     new PhanQuyen(null, canBoNKRole, "GHI_NHAN", "DELETE"),
    //                     // Thống kê
    //                     new PhanQuyen(null, canBoNKRole, "THONG_KE", "READ")
    //             ));
                
    //             // KeToan Permissions - Full CRUD cho Thu chi, Khoản phí, Thiện nguyện
    //             phanQuyenRepository.saveAll(List.of(
    //                     // Khoản chi phí bắt buộc - Full CRUD
    //                     new PhanQuyen(null, keToanRole, "KHOAN_CHI_BAT_BUOC", "READ"),
    //                     new PhanQuyen(null, keToanRole, "KHOAN_CHI_BAT_BUOC", "CREATE"),
    //                     new PhanQuyen(null, keToanRole, "KHOAN_CHI_BAT_BUOC", "UPDATE"),
    //                     new PhanQuyen(null, keToanRole, "KHOAN_CHI_BAT_BUOC", "DELETE"),
    //                     // Danh sách thu - Full CRUD
    ...
    //                     new PhanQuyen(null, keToanRole, "DANH_SACH_THU", "DELETE"),
    //                     // Danh sách chi - Full CRUD
    //                     new PhanQuyen(null, keToanRole, "DANH_SACH_CHI", "READ"),
    //                     new PhanQuyen(null, keToanRole, "DANH_SACH_CHI", "CREATE"),
    //                     new PhanQuyen(null, keToanRole, "DANH_SACH_CHI", "UPDATE"),
    //                     new PhanQuyen(null, keToanRole, "DANH_SACH_CHI", "DELETE"),
    //                     // Hoạt động thiện nguyện - Full CRUD
    //                     new PhanQuyen(null, keToanRole, "HOAT_DONG_THIEN_NGUYEN", "READ"),
    //                     new PhanQuyen(null, keToanRole, "HOAT_DONG_THIEN_NGUYEN", "CREATE"),
    //                     new PhanQuyen(null, keToanRole, "HOAT_DONG_THIEN_NGUYEN", "UPDATE"),
    //                     new PhanQuyen(null, keToanRole, "HOAT_DONG_THIEN_NGUYEN", "DELETE"),
    //                     // Thu thiện nguyện - Full CRUD
    //                     new PhanQuyen(null, keToanRole, "THU_THIEN_NGUYEN", "READ"),
    //                     new PhanQuyen(null, keToanRole, "THU_THIEN_NGUYEN", "CREATE"),
    //                     new PhanQuyen(null, keToanRole, "THU_THIEN_NGUYEN", "UPDATE"),
    //                     new PhanQuyen(null, keToanRole, "THU_THIEN_NGUYEN", "DELETE"),
    //                     // Thống kê
    //                     new PhanQuyen(null, keToanRole, "THONG_KE", "READ")
    //             ));
                
    //             // ToTruong Permissions - Full CRUD cho tất cả (Cán bộ NK + Kế toán)
    //             phanQuyenRepository.saveAll(List.of(
    //                     // Nhân khẩu - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "NHAN_KHAU", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "NHAN_KHAU", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "NHAN_KHAU", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "NHAN_KHAU", "DELETE"),
    //                     // Hộ khẩu - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "HO_KHAU", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "HO_KHAU", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "HO_KHAU", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "HO_KHAU", "DELETE"),
    //                     // Thành viên hộ - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "THANH_VIEN_HO", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "THANH_VIEN_HO", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "THANH_VIEN_HO", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "THANH_VIEN_HO", "DELETE"),
    //                     // Tam trú tạm vắng - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "TAM_TRU_VANG", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "TAM_TRU_VANG", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "TAM_TRU_VANG", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "TAM_TRU_VANG", "DELETE"),
    //                     // Sự kiện - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "SU_KIEN", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "SU_KIEN", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "SU_KIEN", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "SU_KIEN", "DELETE"),
    //                     // Ghi nhận thay đổi hộ khẩu - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "GHI_NHAN", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "GHI_NHAN", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "GHI_NHAN", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "GHI_NHAN", "DELETE"),
    //                     // Khoản chi phí bắt buộc - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "KHOAN_CHI_BAT_BUOC", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "KHOAN_CHI_BAT_BUOC", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "KHOAN_CHI_BAT_BUOC", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "KHOAN_CHI_BAT_BUOC", "DELETE"),
    //                     // Danh sách thu - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_THU", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_THU", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_THU", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_THU", "DELETE"),
    //                     // Danh sách chi - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_CHI", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_CHI", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_CHI", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "DANH_SACH_CHI", "DELETE"),
    //                     // Hoạt động thiện nguyện - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "HOAT_DONG_THIEN_NGUYEN", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "HOAT_DONG_THIEN_NGUYEN", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "HOAT_DONG_THIEN_NGUYEN", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "HOAT_DONG_THIEN_NGUYEN", "DELETE"),
    //                     // Thu thiện nguyện - Full CRUD
    //                     new PhanQuyen(null, toTruongRole, "THU_THIEN_NGUYEN", "READ"),
    //                     new PhanQuyen(null, toTruongRole, "THU_THIEN_NGUYEN", "CREATE"),
    //                     new PhanQuyen(null, toTruongRole, "THU_THIEN_NGUYEN", "UPDATE"),
    //                     new PhanQuyen(null, toTruongRole, "THU_THIEN_NGUYEN", "DELETE"),
    //                     // Thống kê
    //                     new PhanQuyen(null, toTruongRole, "THONG_KE", "READ")
    //             ));
    //         } else {
    ...
    //              VaiTro toTruongRole = vaiTroRepository.findByTenVaiTro("TO_TRUONG");
    ...
    //              taiKhoanRepository.save(new TaiKhoan(null, "totruong", encodedPassword, "Active", toTruongRole));
    //         } else {
